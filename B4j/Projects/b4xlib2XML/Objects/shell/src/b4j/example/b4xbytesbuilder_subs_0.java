...
try {
		Debug.PushSubsStack("Clear (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("getBuffer (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "ba"),__ref,96);
...
try {
		Debug.PushSubsStack("getLength (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "ba"),__ref,85);
...
try {
		Debug.PushSubsStack("IndexOf (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "ba"),__ref,100);
...
try {
		Debug.PushSubsStack("IndexOf2 (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "ba"),__ref,105);
...
try {
		Debug.PushSubsStack("Insert (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "ba"),__ref,36);
...
try {
		Debug.PushSubsStack("Remove (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "ba"),__ref,62);
...
try {
		Debug.PushSubsStack("Set (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("SubArray (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "ba"),__ref,73);
...
try {
		Debug.PushSubsStack("SubArray2 (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "ba"),__ref,79);
...
try {
		Debug.PushSubsStack("ToArray (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "ba"),__ref,90);
